                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="list-group">
                                            ...
                                            @endphp
                                            <p class="list-group-item">{{ $checkout->product($cart->product_id)->name ?? '' }} - Rp.{{ number_format($harga) }} - {{ $checkout->product($cart->product_id)->product_group_id == 1 ? 'Eceran' : 'Koperasi'  }} <span class="badge bg-teal">Jumlah: {{ $cart->stock }}</span></p>
                                            @endforeach
                                        </div>
                                    </td>
